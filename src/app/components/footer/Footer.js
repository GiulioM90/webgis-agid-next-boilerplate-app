                ...
                <div className="pb-2">
                  ...
                  <ul className="list-inline text-left social">
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top"><use href="/bootstrap-italia/dist/svg/sprites.svg#it-designers-italia"></use></svg><span className="visually-hidden">Designers Italia</span></a>
                    </li>
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top"><use href="/bootstrap-italia/dist/svg/sprites.svg#it-twitter"></use></svg><span className="visually-hidden">Twitter</span></a>
                    </li>
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top"><use href="/bootstrap-italia/dist/svg/sprites.svg#it-medium"></use></svg><span className="visually-hidden">Medium</span></a>
                    </li>
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank"><svg className="icon icon-sm icon-white align-top"><use href="/bootstrap-italia/dist/svg/sprites.svg#it-behance"></use></svg><span className="visually-hidden">Behance</span></a>
                    </li>
                  </ul>
                </div>
              </div>
